...
const vec3 luminance_weights_rec2020 = vec3(0.2627, 0.678, 0.0593);
...
vec3 xyz_to_lab(vec3 xyz) {
    const vec3 xyz_n = vec3(95.0489, 100.0, 108.884);
