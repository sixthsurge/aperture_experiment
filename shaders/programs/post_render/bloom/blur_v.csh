...
layout (local_size_x = 1, local_size_y = WORK_GROUP_SIZE, local_size_z = 1) in;
...
void preload() {
    ...
    int group_base = int(gl_WorkGroupID.y) * WORK_GROUP_SIZE - FILTER_RADIUS;
...
void main() {
    ...
    for (int i = -FILTER_RADIUS; i <= FILTER_RADIUS; i++) {
        ivec2 sample_pos = texel + ivec2(0, i);
